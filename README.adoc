...
This software is **dual-licensed**. Choose the license that best fits your use case:

[cols="1,2"]
|===
|License |Description

|link:LICENSE-MIT.txt[MIT License]
|Permissive, minimal restrictions, commercial use permitted

|link:LICENSE-GPL.txt[GPL v3.0+]
|Copyleft, derivative works must be open source, patent protection
|===

SPDX-License-Identifier: MIT OR GPL-3.0-or-later

=== Palimpsest License (Encouraged)

We encourage adoption of the link:LICENSE-PALIMPSEST.txt[Palimpsest License] as a complementary ethical framework emphasizing:
...
The Palimpsest License is philosophically encouraged but not legally required.
