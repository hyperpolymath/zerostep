...
git clone https://github.com/hyperpolymath/zerostep.git cd zerostep
...
toolbox create zerostep-dev toolbox enter zerostep-dev # Install
...
zerostep/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
